...
Original file is located at
    https://colab.research.google.com/drive/1NUS67bTX-SMgTatTB7Ena3kgkSrqGmdp
...
import pandas as pd
call=pd.read_csv('/content/drive/MyDrive/Thesis/Data/input/call.csv')

call.describe().apply(lambda s: s.apply('{0:.5f}'.format))

"""# Split and normalize data"""

train = call[(call['date'] > '2015-12-31') & (call['date'] < '2020-09-01')]
valid = call[(call['date'] >= '2020-09-01') & (call['date'] < '2020-11-01')]
test = call[(call['date'] >= '2020-11-01')]
...
checkpoint_cb = keras.callbacks.ModelCheckpoint("wdnn_call_2.0.h5", save_best_only=True)
...
model = keras.models.load_model("wdnn_call_2.0.h5") 
...
model.save("/content/drive/MyDrive/Thesis/Data/models/wdnn_call_2.0.h5")
test.to_csv('/content/drive/MyDrive/Thesis/Data/output/test_call_2.0.csv')
